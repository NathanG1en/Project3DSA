...
selected_option1 = st.selectbox('Select a category to compare: ', options1, index=None)
...
result = st.button("Search", type="primary", use_container_width=True)
cancel = st.button("Cancel", type="secondary", use_container_width=True)
